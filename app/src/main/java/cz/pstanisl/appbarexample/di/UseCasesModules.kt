...
import cz.pstanisl.appbarexample.ui.detail.ToggleFavoriteUseCase
...
class UseCasesModules {
    ...
    @Provides
    fun providesToggleFavoriteUseCase(inboxRepository: InboxRepository): ToggleFavoriteUseCase {
        return ToggleFavoriteUseCase(inboxRepository)
    }
